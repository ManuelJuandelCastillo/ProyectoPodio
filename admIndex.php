...
// si se presiona el boton de listar equipo
    ...
    <?php if (isset($_POST['listar-equipo'])) { ?>
        <div class="card-container">
            <div class="form-group">
                ...
                <input type="text" id="input-institucion" readonly value="<?= $dataEquipo['nombre_equipo'] ?>">
            </div>
            <div class="form-group">
                <label for="">institucion</label>
                <input type="text" id="input-direccion" readonly value="<?= $dataEquipo['nombre_institucion'] ?>">
            </div>
            <div class="form-group">
                <label for="">localidad</label>
                <input type="text" id="input-localidad" readonly value="<?= $dataEquipo['localidad'] ?>">
            </div>
        </div>
    <?php } ?>
</section>
    ...
    <div class="card-container preferencias-container">
        <div class="form-group">
            ...
            <input type="text" class="input-pref" readonly value="<?php
                                        if($preferencias['cancha_hora']=='C'){echo 'CANCHA';}
                                        if($preferencias['cancha_hora']=='H'){echo 'HORA';}
                                        ?>">
        </div>
        <div class="form-group">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td class="col-name"><?= $jugadora['apellidos'] ?>, <?= $jugadora['nombres'] ?> <?= $faltantes ?></td>
